...
// Data is now loaded from /data/alloys.json
export const ALLOY_DEFINITIONS = null; // Will be loaded dynamically
  ...
  selectAlloy(key) {
    ...
    if (this.smeltTempElm && definition.smeltTemp) {
      ...
      if (this.compatibleFuelsElm) {
        const compatibleFuels = getCompatibleFuels(definition.smeltTemp, this.fuels);
